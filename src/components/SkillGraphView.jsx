...
export default function SkillGraphView({ skills, onNavigate }) {
 ...
 <p className="text-xs text-neutral-500 font-sans mt-0.5">{selectedNode.role || 'Competency Node'}</p>
 </div>
 ...
 <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-wider block">Recommended Next Step:</span>
