    ...
    <div className="fixed bottom-4 left-4 right-4 sm:left-auto sm:right-4 z-50 max-w-md w-auto sm:w-full animate-in slide-in-from-bottom-5 duration-300">
      <div className="bg-stone-900 text-white rounded-3xl p-4 sm:p-5 border border-amber-500/50 shadow-2xl space-y-4 relative overflow-hidden backdrop-blur-md">
        ...
        <div className="flex items-center justify-between border-b border-stone-800 pb-3">
          ...
          <button 
            onClick={onClose}
            className="p-1 rounded-xl text-stone-400 hover:text-white hover:bg-stone-800 transition-colors cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="space-y-2 font-sans text-xs">
          <h3 className="font-bold text-sm text-white font-editorial">{currentStep.title}</h3>
          <p className="text-amber-300 font-semibold text-[11px]">{currentStep.subtitle}</p>
          <p className="text-stone-300 leading-relaxed text-[11px]">{currentStep.description}</p>
          
          <div className="bg-stone-950 p-2.5 rounded-xl border border-stone-800 text-[10px] text-amber-200 font-mono">
        ...
        <div className="flex items-center justify-between pt-1">
          <button
            ...
            className="flex items-center space-x-1 px-3 py-1.5 rounded-xl bg-stone-800 hover:bg-stone-700 text-stone-300 text-xs font-bold disabled:opacity-30 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-stone-950 text-xs font-bold shadow-md cursor-pointer disabled:opacity-40"
          >
            <span>Next Step</span>
